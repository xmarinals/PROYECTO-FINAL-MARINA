...
EmuGSS_TCProgram12_1::EmuGSS_TCProgram12_1(uint32_t uniTime2YK, const char *brief,
		uint16_t pmonid) :
...
EmuGSS_TCProgram12_2::EmuGSS_TCProgram12_2(uint32_t uniTime2YK, const char *brief,
		uint16_t pmonid) :
...
EmuGSS_TCProgram12_5::EmuGSS_TCProgram12_5(uint32_t uniTime2YK, const char *brief,
...
EmuGSS_TCProgram12_6::EmuGSS_TCProgram12_6(uint32_t uniTime2YK, const char *brief,
		uint16_t pmonid) :
