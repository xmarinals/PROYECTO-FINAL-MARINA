...
#define TC_128_1_PACK_BYTES  (10 + TC_2_1_APPDATA_LENGTH + 2)
#define TC_19_1_ACT_128_1_APPDATA_LENGTH (2 + TC_128_1_PACK_BYTES)
...
EmuGSS_TCProgram19_1_Action_2_1::EmuGSS_TCProgram19_1_Action_2_1(
		uint32_t uniTime2YK, const char *brief, uint16_t evID, uint8_t deviceID,
		enum DeviceCommandOnOff_t devicecommand) :
		EmuGSS_TCProgram(uniTime2YK, 19, 1,
		TC_19_1_ACT_2_1_APPDATA_LENGTH, brief), mProgram_2_1(deviceID,
				devicecommand) {
...
void EmuGSS_TCProgram19_1_Action_128_1::BuildTCAppData(
	...
	tc_descriptor_t tc_128_1_descriptor;
