#ifndef UAHEXPLORER_H_
#define UAHEXPLORER_H_
 ...
 *
 */
class UAHExplorer: public CEDROOMComponent {

public:

	/**
	 * \enum TEDROOMUAHExplorerSignal
	 * \brief Component Signal Enum Type
	 *
	 */
	 enum TEDROOMUAHExplorerSignal { EDROOMSignalTimeout, 
							EDROOMSignalDestroy };

	/**
	 * \class UAHExplorer::CEDROOMMemory
	...
	//! Constructor
	UAHExplorer(TEDROOMComponentID id, TEDROOMUInt32 roomNumMaxMens, TEDROOMPriority roomtaskPrio, 
...
public:
	...
	enum TEDROOMUAHExplorerSignal { EDROOMSignalTimeout,
		...
		friend class UAHExplorer;

		//!component reference
		UAHExplorer &EDROOMcomponent;
		...
		//!Constructor
		EDROOM_CTX_Top_0 (UAHExplorer &act,
	...
	public:
		...
		//! Constructor
		EDROOM_SUB_Top_0 (UAHExplorer &act );
